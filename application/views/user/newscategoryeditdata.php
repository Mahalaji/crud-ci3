...
<h2 class="header"> Edit-News-Category</h2>
<div class="form1">
    <form class="simple" method="post" action="<?php echo base_url('newscategoryedit')?>" enctype="multipart/form-data">
        ...
        <div class="submit">
            <button type="submit" class="btn" name="update">Update News Category</button>
        </div>
