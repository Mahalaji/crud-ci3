        ...
        <div class="info" style=" background: white;">
            ...
            <div class="header"
                ...
                <div id="back">
                    ...
                    <a href="<?php echo base_url('blogcategoryadd'); ?>" style="    padding: 3px;
                                       background: azure;
                                       border-radius: 5px;
                                     font-size: 23px;
                    ...
                    <?php 
                     foreach ($blogcategory as $u): ?>
                        ...
                        <!-- <td><?php echo $u['id']; ?></td> -->
                            ...
                            <td><a href="<?php echo base_url('blogcategoryeditdata/' . $u['id']); ?>"><i class='fas fa-edit' style='font-size:24px'></i></a></td> 
                            <td><a href="<?php echo base_url('blogcategorydelete/' . $u['id']); ?>"><i class='fas fa-trash'
