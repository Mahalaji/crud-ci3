...
<body>
    <div class="dashboard">
        ...
        <main class="main-content">
            ...
            <form id="update" method="post" action="<?php echo base_url('edit')?>" >
                <div id="d">
                    <div>
                        <div class="input-group">
                            <label>Name</label>
                            <input type="text" id="Name" name="Name" onkeyup="lettersOnly(this)" value="<?php echo $user['Name']; ?>" >
				...
				<div class="error-message"> <?= form_error('Title') ?></div>
                    ...
                    <div>
                        ...
                        <div class="input-group">
                            ...
                            <input type="date" id="Create Date" name="Create_Date" value="<?php echo $user['Create_Date']; ?>" >
                        </div>
                        <div class="input-group">
                            <label>Update Date</label>
                            <input type="date" id="Update Date" name="Update_Date" value="<?php echo $user['Update_Date']; ?>" >
                        </div>
